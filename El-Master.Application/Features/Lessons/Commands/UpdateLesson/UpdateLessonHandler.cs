...
//            try
//            {
//                var lesson = await _lessonRepository.GetLessonAsync(request.LessonId);
...
//                string? oldVideo = lesson.VideoPath;
...
//                {
//                    await AddAttachmentsAsync(lesson, request.Dto.Attachments); 
//                }

//                await _lessonRepository.SaveChangesAsync();

//                if (newVideoPath != null && !string.IsNullOrEmpty(oldVideo))
//                {
//                    _fileStorage.DeleteFile(oldVideo);
//                }

//                var lessonDto = mapper.Map<LessonDetailsDto>(lesson);

//                return Result<LessonDetailsDto>.Success(lessonDto, "Less  on updated successfully");
//            }
//            catch
//            {
